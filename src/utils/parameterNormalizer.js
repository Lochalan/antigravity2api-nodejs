...
// Converts OpenAI, Claude, Gemini formats to internal format
...
export function normalizeOpenAIParameters(params = {}) {
  ...
  if (params.thinking_budget !== undefined) {
    ...
    normalized.thinking_budget = config.reasoningEffort[params.reasoning_effort];
  }
...
export function normalizeClaudeParameters(params = {}) {
  ...
  // Process Claude's thinking parameter
...
export function normalizeGeminiParameters(generationConfig = {}) {
  ...
  // Process Gemini's thinkingConfig parameter
 ...
 * @param {Object} params - Raw parameter object
